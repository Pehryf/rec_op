...
function Train-Model {
    ...
    Run-Stage "[$S] Stage 1 — small instances, brute-force labels" `
    ...
    Run-Stage "[$S] Stage 2 — medium instances, NN labels, mixed sizes" `
    ...
    Run-Stage "[$S] Stage 3 — large instances, NN labels, mixed sizes" `
